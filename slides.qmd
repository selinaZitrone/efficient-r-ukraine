...
title-slide-attributes: 
  data-background-image: img/grassland5.JPG
format: 
  revealjs:
...
## Efficient R {.slide-title background-image="img/grassland5.JPG"}
...
## Welcome {background-image="img/grassland5.JPG"}
...
:package: Material (Slides, Code, References & Resources) on [Github](https://github.com/selinaZitrone/efficient-r-ukraine)<br>
...
- [`memoise`](https://memoise.r-lib.org/): Cache function calls
- ...
...
![](img/sequential.png){width="30%" fig-align="center"}
...
1. **Identify the bottlenecks** with profiling and benchmarking
...
2. **Optimize the bottlenecks**
  - Vectorize your code, write smart for loops, cache variables
  - Use efficient data formats and packages
  - Parallelize your code with the `futureverse`
  - If necessary: Rewrite slow functions in C++
...
Making R code more efficient is (often) not that hard!

- Many packages make it easy to speed up your code without much effort and rewriting
- Many quick wins, e.g.
...
## Thank you for your attention {background-image="img/grassland5.JPG"}
Questions?
